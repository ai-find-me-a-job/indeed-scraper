...
class IndeedJobSpider(scrapy.Spider):
    ...
    def start_requests(self):
        keyword_list = ["java developer"]
        location_list = ["São Paulo"]
        for keyword in keyword_list:
            for location in location_list:
                indeed_jobs_url = self.get_indeed_search_url(keyword, location)
                # indeed_jobs_url = "https://br.indeed.com/empregos?q=java+developer&l=S%C3%A3o+Paulo%2C+SP&radius=0&vjk=b451569d1c202870"
    ...
    def parse_job(self, response):
        ...
        if script_tag is not None:
            ...
            sanitizedJobDescription = json_blob["jobInfoWrapperModel"]["jobInfoModel"][
